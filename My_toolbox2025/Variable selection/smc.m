...
% Implementation of Significance Multivariate Correlation for variable
% importance in PLS
% [smcF smcFcrit SSCregression SSResidual] = smc(b, X)
% Input: 
%   x: Data matrix n samples x variables (Assumed centered)
%   b: PLS regression coefficients (without constant term)
% Output:
...
smcFcrit = ftest(alpha_mc,1,n-2);   % Originally using matlabs finv function: finv(1-alpha_mc,1,n-2) Here use PLS toolbox: ftest(alpha_mc,1,n-2)
