WARNING('does not work for datetime yet')
...
% Based on Peter (2022). Break X Axis (https://www.mathworks.com/matlabcentral/fileexchange/42905-break-x-axis), MATLAB Central File Exchange. Retrieved November 7, 2022.

function breakInfo = breaktimeaxis(varargin)
